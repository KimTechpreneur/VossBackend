"""
URL configuration for VossBackend project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="Voss Backend API",
        default_version='v1',
        description="API documentation for Voss Backend",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="contact@voss.com"),
